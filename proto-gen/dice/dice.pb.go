...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_dice_proto_msgTypes[0]
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_protoc_dice_proto_rawDescGZIP(), []int{0}
}
...
func (x *Pong) Reset() {
	*x = Pong{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_dice_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Pong) Descriptor() ([]byte, []int) {
	return file_protoc_dice_proto_rawDescGZIP(), []int{1}
}
...
func (x *RollDiceRequest) Reset() {
	*x = RollDiceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_dice_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RollDiceRequest) Descriptor() ([]byte, []int) {
	return file_protoc_dice_proto_rawDescGZIP(), []int{2}
}
...
func (x *RollDiceResponse) Reset() {
	*x = RollDiceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_dice_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RollDiceResponse) Descriptor() ([]byte, []int) {
	return file_protoc_dice_proto_rawDescGZIP(), []int{3}
}
...
var File_protoc_dice_proto protoreflect.FileDescriptor

var file_protoc_dice_proto_rawDesc = []byte{
	0x0a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x2f, 0x64, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72,
...
var (
	file_protoc_dice_proto_rawDescOnce sync.Once
	file_protoc_dice_proto_rawDescData = file_protoc_dice_proto_rawDesc
)

func file_protoc_dice_proto_rawDescGZIP() []byte {
	file_protoc_dice_proto_rawDescOnce.Do(func() {
		file_protoc_dice_proto_rawDescData = protoimpl.X.CompressGZIP(file_protoc_dice_proto_rawDescData)
	})
	return file_protoc_dice_proto_rawDescData
}

var file_protoc_dice_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_protoc_dice_proto_goTypes = []interface{}{
	(*Empty)(nil),            // 0: Empty
	(*Pong)(nil),             // 1: Pong
	(*RollDiceRequest)(nil),  // 2: RollDiceRequest
	(*RollDiceResponse)(nil), // 3: RollDiceResponse
}
var file_protoc_dice_proto_depIdxs = []int32{
...
func init() { file_protoc_dice_proto_init() }
func file_protoc_dice_proto_init() {
	if File_protoc_dice_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_protoc_dice_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protoc_dice_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protoc_dice_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoc_dice_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protoc_dice_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_protoc_dice_proto_goTypes,
		DependencyIndexes: file_protoc_dice_proto_depIdxs,
		MessageInfos:      file_protoc_dice_proto_msgTypes,
	}.Build()
	File_protoc_dice_proto = out.File
	file_protoc_dice_proto_rawDesc = nil
	file_protoc_dice_proto_goTypes = nil
	file_protoc_dice_proto_depIdxs = nil
}
